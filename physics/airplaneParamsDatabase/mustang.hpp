...
namespace Physics
{
	namespace database::mustang
	{
		...
		inline constexpr glm::vec3 hStabLiftPoint{0, 0.32f, 8.34f};
		inline constexpr glm::vec3 hStabNormalForcePoint{0, 0.32f, 8.62f};
		...
		inline constexpr glm::vec3 elevatorForcePoint{0, 0.32f, 8.62f};
		...
		inline constexpr glm::vec3 vStabLiftPoint{0, 0.87f, 8.7f};
		inline constexpr glm::vec3 vStabNormalForcePoint{0, 0.87f, 9.01f};
		...
		inline constexpr glm::vec3 rudderForcePoint{0, 0.79f, 9.13f};
		...
		inline constexpr glm::vec3 rightWingLiftPoint{2.62f, -0.56f, 3.45f};
		inline constexpr glm::vec3 rightWingNormalForcePoint{2.62f, -0.56f, 3.93f};
		...
		inline constexpr glm::vec3 rightAileronForcePoint{4.25f, -0.56f, 3.77f};
		...
		inline constexpr glm::vec3 fuselageSideDragPoint{0, 0, 4.61f};

		inline constexpr float maxThrust = 5500;
		inline constexpr glm::vec3 thrustPoint{0, 0, 0.44f};
	}
